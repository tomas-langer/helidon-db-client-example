...
/**
 * Common functionality of the DB service.
 */
public abstract class PokemonServiceCommon implements Service {
    private static final Logger LOGGER = Logger.getLogger(PokemonServiceCommon.class.getName());

    private final DbClient dbClient;

    protected PokemonServiceCommon(DbClient dbClient) {
    ...
    public void update(Routing.Rules rules) {
        rules
                ...
                .post("/transactional", Handler.create(Pokemon.class, this::transactional))
