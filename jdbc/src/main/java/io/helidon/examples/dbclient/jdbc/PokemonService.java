...
import io.helidon.examples.dbclient.common.PokemonServiceCommon;
 ...
 */
public class PokemonService extends PokemonServiceCommon {
        ...
        dbClient.execute(handle -> handle.namedDml("create-table"))
                ...
                .exceptionally(throwable -> {
                    LOGGER.log(Level.WARNING,
                               "Failed to create table, maybe it already exists? Message: " + throwable.getMessage());
                    return null;
                });
    }
